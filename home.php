...
<body>
	...
	<div id="top_banner">
		<form method="post" action="sign_in_form.php">
			<div>
				<span class="left">Welcome to <span id="logo">QuizzeMe</span> An Online Multiple Choice Question quizzes</span>
			</div>
			<div class="right">
	...
	<div class="form_style">
		...
		<form class="form_style" method="post" action="quiz.php">
			<div>Start as visitor!</div>
			<div class="submit">
				<input class="button" type="submit" value="Quiz Me Now!" />
			</div>
		</form>
